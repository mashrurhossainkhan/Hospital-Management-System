...
$sql = "SELECT * FROM `hospitalregistration` WHERE `AdminorDoctor`='Doctor'";
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<div class='row'>";
                ...
                echo '<img class="img"; src="data:image/jpeg;base64,' . base64_encode( $row['Pic'] ) . '" />';
                    ...
                    echo "<p style='text-align:center;font-family: Comic Sans MS;'>Time: From ".$row['time1']."to ".$row['time2']."</p>";
            echo "</a>";
            echo "</div>";
