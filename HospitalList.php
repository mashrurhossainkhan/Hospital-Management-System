...
<body  style="margin-top: 0px ; margin-right: 0px ; margin-left: 0px">
    ...
    ?>
        <form action="searchresult.php" method="post">
            <center><input class="sign" type="text" name="search" placeholder="Search Your Books Here">
...
$sql = "SELECT * FROM `hospitalregistration`";
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<div class='row'>";
                    echo "<div class='column'>";
                         ...
                         echo '<img class="img" src="medpro.jpeg"/>';
